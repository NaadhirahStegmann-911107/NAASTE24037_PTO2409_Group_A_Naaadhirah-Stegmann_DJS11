...
interface FavoritesModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  toggleFavorite: (showId: number, seasonId: number, episodeId: number) => void;
}
...
export const FavoritesModal: React.FC<FavoritesModalProps> = ({
  ...
  return (
    <div className="modal-backdrop" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="favorites-title">
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <button onClick={onClose} className="close-modal-btn" aria-label="Close favorites modal">
          ×
        </button>
